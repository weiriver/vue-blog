...
const {
  create, getList, output, upload, checkExist,
  uploadConfirm, outputAll, findById, update, delete: del, createBlogFromYoudao
} = require('../controllers/article')


router
  .post('/', create) // 创建文章
  .post('/youdao', createBlogFromYoudao) // 同步有道云文章
